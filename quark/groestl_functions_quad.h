...
/**
 * __shfl_sync(0xFFFFFFFFu, ) returns the value of var held by the thread whose ID is given by srcLane.
...
#define A(v, u)             __shfl_sync(0xFFFFFFFFu, (int)r[v], ((threadIdx.x+u)&0x03), 4)
